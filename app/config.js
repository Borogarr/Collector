require.config({
	...
	paths: {
		...
		'app.item.edit' : 'user/collections/items/editItem/editItem',
		'app.collection.edit' : 'user/collections/editCollection/editCollection',
		'app.user.edit' : 'user/editUser/editUser',
		'app.item.editServer' : 'user/collections/items/editItem/editServer',
		'app.user.editUserServer' : 'user/editUser/editUserServer',
		'app.item.view' : 'user/collections/items/view/itemView',
