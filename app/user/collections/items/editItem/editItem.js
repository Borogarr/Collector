		...
		'app.item.itemServer'
			...
			module.config(['$stateProvider',
				function($stateProvider) {
					...
					$stateProvider.state('app.item.edit', {
						controller: 'itemEditController',
						url: '/:itemId/editItem',
						templateUrl: 'user/collections/items/item_edit.html',
						resolve: {
							'item': ['itemServer',
								function(itemServer) {
			...
			module.controller('itemEditController', ['$scope', '$state', 'collectionId', 'itemServer', '$fileUploader', 'item','items',
				function($scope,$state,collectionId,itemServer,$fileUploader,item,items) {
					console.log('itemEditController');
					...
					$scope.saveItem = function() {
						...
						itemServer.update($scope.item).then(
							function success(response) {
								reset();
								console.log(response);
